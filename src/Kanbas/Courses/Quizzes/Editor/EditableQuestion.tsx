...
export default function EditableQuestion({ key, question, index, updateQuestion}: 
    { key: any, question: any; index: number, updateQuestion : any}) {
    ...
    return (
        <div className='wd-module list-group-item p-0 mb-4 fs-5 w-75'>
            {!editing ?
                <li className='wd-module list-group-item p-0 mb-4 fs-5' key={key}>
                ...
                <li className='wd-module list-group-item p-3 mb-4 fs-5' key={key}>
